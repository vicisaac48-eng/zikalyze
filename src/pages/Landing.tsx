...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      {/* Header */}
      <header className={`fixed-header relative z-10 flex items-center justify-between px-4 py-3 sm:px-6 sm:py-4 md:px-12 lg:px-16 xl:px-24 bg-background/95 backdrop-blur-sm${isNativeApp ? ' android-fixed' : ''}`}>
      ...
      {/* Hero Section */}
      <main className={`relative z-10 flex flex-col items-center justify-center px-4 py-12 text-center sm:px-6 md:py-20 lg:py-28 xl:py-32${isNativeApp ? ' main-content' : ''}`}>
